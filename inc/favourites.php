<div class="row favourites">
  ...
  <div class="clearfix" id="carouselControls"> <a class="left carousel-control" id="prev2" href="#myCarousel">‹</a> <a class="right carousel-control" id="next2" href="#myCarousel">›</a> </div>
  <!--/span--> 
</div>