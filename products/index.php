      ...
      <div class="span12">
        ...
        <div id="productsWrapper">
          ...
          <div class="fleft product <?php echo $product_line->colour; ?>">
            <?php $pic = $product_line->getProducts(); ?>
            <a href="<?php echo BASE_URL.'products/line/?id='.$product_line->id; ?>"> <img title="<?php echo $product_line->name; ?>" src="../img/catalog/<?php echo reset($pic)->pic; ?>.png"/> </a>
